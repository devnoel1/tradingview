...
<div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-paper-plane icon-gradient bg-tempting-azure">
                                        </i>
                                    </div>
                                    <div>CRM-Communications
                        ...
                        <div class="main-card mb-3 card table-responsive">
                                    ...
                                    <div class="card-body"><h5 class="card-title">Communications</h5>
   	...
   	if(title=="Action" )
        {
          ...
          var st_drop='<a style="color:white;" href="#" class=" col-md-12 btn-wide mb-2 mr-2 btn-icon btn btn-success"><i class="fa fa-plus btn-icon-wrapper" style="color:white;"> </i></a>';
          ...
          if(title=="Time" )
        {
          ...
          var st_drop='<input type="datetime-local"/>';

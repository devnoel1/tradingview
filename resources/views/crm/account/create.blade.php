...
<div class="app-main__inner">
                        ...
                        <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <form class="" autocompelte="off"  method="POST" action="{{route('crm.account.store')}}">
                                        @csrf
                                            <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group">
                                                            <label for="exampleEmail11" class="">First Name</label>
                                                            <input  name="name" id="exampleEmail11" placeholder="Enter First Name" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group">
                                                            <label for="examplePassword11" class="">Last Name</label>
                                                        <input name="lastname" id="examplePassword11" placeholder="Enter Last Name" type="text" class="form-control">
                                                    </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input name="second_email" id="examplePassword11" placeholder="Second Email" type="text" class="form-control">
                                                    </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input name="date_of_birth" id="examplePassword11" placeholder="Second Email" type="date" class="form-control">
                                                    </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="address_line_1" id="exampleAddress" placeholder="1234 Main St" type="text" class="form-control">
                                            </div>

                                            <div class="position-relative form-group">
                                                <label for="exampleAddress2" class="">Address 2</label>
                                                <input name="address_line_2" id="exampleAddress2" placeholder="Apartment, studio, or floor" type="text" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="zipcode" id="exampleZip" placeholder="Zipcode" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">

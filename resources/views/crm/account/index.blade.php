...
<div class="app-main__inner">
  ...
  <div class="main-card mb-3 card">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-2">
          <a style="color:white;" href="{{route('crm.account.create')}}" class=" btn-icon btn btn-success"><i
              class="fa fa-plus btn-icon-wrapper" style="color:white;"> </i> Create Account</a>
        </div>
            ...
            <td>
              <div class="btn-group">
                <a type="button" class="btn btn-info" target="_blank"
                  href="{{route('crm.account.show', ['account' => $user->id])}}">
                  <i class="fas fa-eye"></i>
                </a>
                <a type="button" class="btn btn-info" href="{{route('crm.account.edit', ['account' => $user->id])}}"><i
                    class="fas fa-pen"></i></a>
                <a type="button" class="btn btn-danger del"
                  href="{{route('crm.account.destroy', ['account' => $user->id])}}"><i class="fas fa-trash"></i></a>
...
@include('crm.modals.accountModal')
@endsection
@endsection

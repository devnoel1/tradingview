                            ...
                            <tr>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a type="button" class="btn btn-danger del" href=""><i
                                ...
                                <td>{{ $agent->name }}</td>
                                <td>{{ $agent->role }}</td>
                                <td>{{ Hash::check('plain-text', $agent->password) }}</td>
                                <td>{{ $agent->status }}</td>
        ...
        $(document).ready(function() {
            ...
            $('#user_table tfoot th').each(function() {
                ...
                if (title == "Action") {
                    ...
                    var st_drop =
                        '<a style="color:white;" href="{{ route('crm.agent.create') }}" class=" col-md-12 btn-wide mb-2 mr-2 btn-icon btn btn-success"><i class="fa fa-plus btn-icon-wrapper" style="color:white;"> </i></a>';
            ...
            table = $('#user_table').DataTable({
                ...
                initComplete: function() {
                    ...
                    this.api().columns().every(function() {
                        ...
                        $('input[type=text]', this.footer()).on('keyup change clear',
                    function() {

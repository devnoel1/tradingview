...
@section('content')
       ...
       @foreach ($affiliateleads as $afflead)
      @endforeach


    <form class="form-horizontal" method="POST" action="{{route('crm.leads.store')}}">
        @csrf
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit a Lead</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="firstname" class="form-control" id="inputFirstName" value= "{{ $afflead->first_name }}" placeholder="First name" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputLastName" class="col-sm-2 col-form-label">Last name</label>
                <div class="col-sm-10">
                    <input type="text" name="lastname" class="form-control" value= "{{ $afflead->last_name }}" id="inputLastName" placeholder="Last name" required>
                </div>
            </div>
            <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                        <input type="email" name="email" class="form-control" value= "{{ $afflead->email }}" id="inputEmail" placeholder="Email" required>
                    </div>
                </div>
              <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Phone</label>
                    <div class="col-sm-10">
                        <input type="text" name="phone" class="form-control" value= "{{ $afflead->phone }}" id="" placeholder="Phone Number" >
                    </div>
                </div>
            <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Reset Password</label>
                    <div class="col-sm-10">
                        <input type="password" name="passowrd" autocomplete="new-password" class="form-control"  placeholder="Rest Password" >
                    </div>
                </div>
                  <hr/>
              <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="address_line_1" class="form-control"  value= "{{ $afflead->address }}" id="inputAddressLine1"  placeholder="Address Line 1" required>
                    </div>
                </div>
                <div class="form-group row">
           ...
           <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control js-example-basic-single" name="time_zone">
    ...
    <option value="+14:00">(GMT +14:00) Line Islands, Tokelau</option>
           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="inputExternaId" class="col-sm-2 col-form-label">External id</label>
                <div class="col-sm-10">
                    <input type="text" name="external_i" class="form-control" autocomplete="off"   placeholder="External Id" >
                </div>
            </div>
           <div class="form-group row">
                <label for="inputExternalId" class="col-sm-2 col-form-label">Comment</label>
                <div class="col-sm-10">
                    <input type="text" name="comment" class="form-control" id="" placeholder="Comment">
                </div>
            </div>

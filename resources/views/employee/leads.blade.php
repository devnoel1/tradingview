            ...
            <table class="table table-bordered" id="lead_table">
                ...
                <tr>
                   ...
                   <td>{{ $user->lead_status }}</td>
                    <td>
                        <div class="btn-group">
                            <a type="button" class="btn btn-info" href="{{route('employee.create',$user->id)}}">+Add</a>
                            <a type="button" class="btn btn-info" href="{{route('employee.lead.show',$user->id)}}">Show</a>

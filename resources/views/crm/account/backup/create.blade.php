...
@section('content')
    <div class="card">
        ...
        @endif
        <form class="form-horizontal" method="POST" action="{{route('crm.account.store')}}">
            @csrf
            <div class="card-body">
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="phone" class="form-control" id="inputEmail" placeholder="Phone Number" >
                    </div>
                </div>
                  <hr/>
              <div class="form-group row">
...
<option value="Afganistan">Afghanistan</option>
   ...
   <option value="Zimbabwe">Zimbabwe</option></select>
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="ip" class="form-control" id="inputState" placeholder="IP Address" value="" >
                    </div>
                </div>
                <div class="form-group row">
    ...
    <option value="+14:00">(GMT +14:00) Line Islands, Tokelau</option>
                ...
                <div class="form-group row">
                    <label for="inputExchange" class="col-sm-2 col-form-label">Desk</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="inputExchange" class="col-sm-2 col-form-label">Agent</label>
                    <div class="col-sm-10">
               ...
               <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label for="inputExchange" class="col-sm-2 col-form-label">Campaigns</label>
                    <div class="col-sm-10">
